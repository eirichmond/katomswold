<?php
/**
 * Title: House Card Search Country
 * Slug: katomswold/house-card-search-country
 * Categories: house-card-search
 */
?>

<!-- wp:group {"metadata":{"categories":["house-card-search"],"patternName":"katomswold/house-card-search-country"},"style":{"dimensions":{"minHeight":"365px"}},"backgroundColor":"white"} -->
<div class="wp-block-group has-white-background-color has-background" style="min-height:365px"><!-- wp:post-featured-image {"isLink":true} /-->

<!-- wp:post-title {"textAlign":"center","isLink":true,"style":{"spacing":{"padding":{"top":"var:preset|spacing|40","bottom":"var:preset|spacing|40"}},"elements":{"link":{"color":{"text":"var:preset|color|white"}}},"typography":{"fontStyle":"normal","fontWeight":"600"}},"backgroundColor":"titlecolorthree","textColor":"white","fontSize":"small"} /-->
...
<p class="has-x-small-font-size">Sleeps </p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"metadata":{"bindings":{"content":{"source":"core/post-meta","args":{"key":"sleeps_min"}}}},"fontSize":"x-small"} -->
<p class="has-x-small-font-size"></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"fontSize":"x-small"} -->
<p class="has-x-small-font-size"> to </p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"metadata":{"bindings":{"content":{"source":"core/post-meta","args":{"key":"sleeps_max"}}}},"fontSize":"x-small"} -->
<p class="has-x-small-font-size"></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
