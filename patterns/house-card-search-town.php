<?php
/**
 * Title: House Card Search Town
 * Slug: katomswold/house-card-search-town
 * Categories: house-card-search
 */
?>

<!-- wp:group {"metadata":{"categories":["house-card-search"],"patternName":"katomswold/house-card-search-town"},"style":{"dimensions":{"minHeight":"365px"}},"backgroundColor":"white"} -->
...
<!-- wp:post-title {"textAlign":"center","isLink":true,"style":{"spacing":{"padding":{"top":"var:preset|spacing|40","bottom":"var:preset|spacing|40"}},"elements":{"link":{"color":{"text":"var:preset|color|white"}}},"typography":{"fontStyle":"normal","fontWeight":"600"}},"backgroundColor":"coloreight","textColor":"white","fontSize":"small"} /-->
