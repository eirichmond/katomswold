<?php
/**
 * Title: House Card Search Cotswolds
 * Slug: katomswold/house-card-search-cotswolds
 * Categories: house-card-search
 */
?>

<!-- wp:group {"metadata":{"categories":["house-card-search"],"patternName":"katomswold/house-card-search-cotswolds"},"style":{"dimensions":{"minHeight":"365px"}},"backgroundColor":"white"} -->
...
<!-- wp:post-title {"textAlign":"center","isLink":true,"style":{"spacing":{"padding":{"top":"var:preset|spacing|40","bottom":"var:preset|spacing|40"}},"elements":{"link":{"color":{"text":"var:preset|color|white"}}},"typography":{"fontStyle":"normal","fontWeight":"600"}},"backgroundColor":"colorfive","textColor":"white","fontSize":"small"} /-->
