<?php
/**
 * Title: House Card Search Signature
 * Slug: katomswold/house-card-search-signature
 * Categories: house-card-search
 */
?>

<!-- wp:group {"metadata":{"categories":["house-card-search"],"patternName":"katomswold/house-card-search-signature"},"style":{"dimensions":{"minHeight":"365px"}},"backgroundColor":"white"} -->
